...
const en = {
  ...
  catFinance: 'Finance',
  catTeam: 'Team',
  catCustom: 'Saved by you',
  runReport: 'Run report',
  scheduleIt: 'Schedule',
  saveAsReport: 'Save as report',
  savedAsReport: 'Saved to Reports',
...
const ur: Strings = {
  ...
  catFinance: 'مالیات',
  catTeam: 'ٹیم',
  catCustom: 'آپ کی محفوظ کردہ',
  runReport: 'رپورٹ چلائیں',
  scheduleIt: 'شیڈول',
  saveAsReport: 'رپورٹ کے طور پر محفوظ کریں',
  savedAsReport: 'رپورٹس میں محفوظ ہو گئی',
